...
if(!$fopen) {
    ...
    file_put_contents('../voctanpdatabase/'.$_GET['code'].'.json', $newJsonString);
}
?>
<!DOCTYPE html>
<html>
<head>
	...
	<title>https://egift.id/dzj3a1s/</title>
...
<div id="divWrap">
	<div id="divMain">
		...
		<div class="subWrap">
			<div class="subIn">
				<div class="clear"></div>
				<!--h2>NO ORDER: <span id="p_sepin_mno">DU8A27R3210001</span></h2-->
				<div class="clear" style="height: 10px;"></div>
				<div style="text-align: center; margin-bottom: 10px;">
					<div style="font-size: 1.6em;"><span id="p_item_name"><?php echo $val; ?></span></div>
				</div>
				<div style="text-align: center;">
					<img class="grayscaleOn" id="prodInfo_img" src="<?php echo $image; ?>" style="width: 230px;">
				</div>
				...
				<div style="text-align: center; margin-bottom: 10px; font-size: 1.6em;">
					<span id="pp_exchange_date" style="visibility: visible;"><span id="p_exchange_date">201912010427</span></span>
				</div>
				...
				<div class="barcode" style="margin: 4px 0;">
					<div id="barcodeTarget" style="margin: 0 auto; visibility: hidden"></div>
				</div>
				<div class="barcode qrcode" style="margin: 4px 0;">
					<div id="qrcodeTarget" style="margin: 0 auto;"></div>
				</div>
				...
				<div class="click-disable" style="visibility: visible; text-align: center;">
					<font style="font-size:10px;">Sudah pakai Voucher ini. Tidak bisa digunakan lagi.'</font>
				</div>
			</div>
		</div>
	</div><!-- End divMain -->
