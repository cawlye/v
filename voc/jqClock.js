	...
	$.fn.clock = function(options) {
		...
		this.each(function(idx){
			if(typeof options === 'undefined' || typeof options === 'object'){
				...
				options.langSet		= options.langSet	|| "id";
				options.calendar	= options.hasOwnProperty("calendar") ? options.calendar	: true;
				options.dateFormat	= options.dateFormat	|| ((options.langSet=="id") ? "l, F j, Y" : "l, j F Y");
				options.timeFormat	= options.timeFormat	|| ((options.langSet=="id") ? "h:i:s A" : "H:i:s");
